...
def add_one(some_list):
    list_ = []
    while some_list:
        list_.append(str(some_list.pop(0)))
    list_ = list(str(int(''.join(list_)) + 1))
    while list_:
        some_list.append(int(list_.pop(0)))
    return some_list

    # nums = int(''.join(list(map(str, some_list)))) + 1
    # res = list(map(int, str(nums)))
    # return res
